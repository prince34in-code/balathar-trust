...
const CONTENT = {
  ...
  trustBadges: [
    ...
    { icon: "🛡️", title: "सम्मान सर्वोपरि", text: "परिवारों की गरिमा और गोपनीयता" },
    { icon: "🏘️", title: "स्थानीय समुदाय का भरोसा", text: "15+ गांवों तक सक्रिय पहुंच" }
  ],
